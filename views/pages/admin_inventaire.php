    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
        <?php if($can_manage_catalog): ?>
            <a href="index.php?action=add_produit" class="btn-carre" style="background: #2ecc71; border: none; color: white; max-width: 250px; margin: 0; display: flex; align-items: center; justify-content: center; gap: 10px; box-shadow: 0 0 15px rgba(46, 204, 113, 0.4);">
                ➕ Nouveau Produit
            </a>
        <?php endif; ?>
    </div>
